...
from goli.nn.architectures import FeedForwardNN, FeedForwardDGL, FeedForwardPyg #, FullDGLNetwork, FullDGLSiameseNetwork
...
class test_FeedForwardGraph(ut.TestCase):
    ...
    g1 = Data(x=h1, edge_index=torch.stack(edge_idx1), edge_attr=e1)
    g2 = Data(x=h2, edge_index=torch.stack(edge_idx2), edge_attr=e2)
