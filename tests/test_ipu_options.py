...
def test_ipu_options():
    ...
    assert ipu_inference_opts == expected_ipu_inference_opts, f"Expected {expected_ipu_inference_opts}, but got {ipu_inference_opts}"
    ...
    assert ipu_training_opts.replication_factor == 16, "Expected replication_factor of ipu_training_opts to be 16"
    assert ipu_inference_opts.replication_factor == 4, "Expected replication_factor of ipu_inference_opts to be 4"
