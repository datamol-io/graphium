...
class DictTensor(dict):
    ...
    def _dict_func_wrapper(self, func):
        """
        ...
        def wrap(dict_obj, *args, **kwargs):
            ...
            if hasattr(func, "__self__"):
                ...
                dict_obj, this_args = this_args[0], this_args[1:]
            ...
            if all([isinstance(v, Tensor) for v in out.values()]):
                out = DictTensor(out)
            return out
        return wrap
    ...
    def __init__(self, dict_tensor):
        ...
        func_names_to_register = tensor_func_names - dict_func_names - self.not_accepted_methods
